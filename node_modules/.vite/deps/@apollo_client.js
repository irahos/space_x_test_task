...
var FragmentRegistry = (
  ...
  function() {
    ...
    FragmentRegistry2.prototype.cacheUnaryMethod = function(originalMethod) {
      return wrap2(originalMethod.bind(this), {
...
var useSyncExternalStore = realHook || function(subscribe, getSnapshot, getServerSnapshot) {
  ...
  if (
    ...
    globalThis.__DEV__ !== false && invariant2.error(58);
  }
...
function parser(document) {
  ...
  invariant2(!!document && !!document.kind, 59, document);
  var fragments = [];
  var queries = [];
  var mutations = [];
  var subscriptions = [];
  ...
  invariant2(!fragments.length || queries.length || mutations.length || subscriptions.length, 60);
  invariant2(
  ...
  invariant2(definitions.length === 1, 62, document, definitions.length);
...
function validateFetchPolicy(fetchPolicy) {
  ...
  invariant2(supportedFetchPolicies.includes(fetchPolicy), 56, fetchPolicy);
}
...
function useReadQuery(queryRef) {
  ...
  invariant2(internalQueryRef.promiseCache, 51);
